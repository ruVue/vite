...
Тем не менее, `esbuild` значительно продвинулся за последние годы, и мы не исключаем возможности использования `esbuild` для промышленных сборок в будущем. Мы продолжим использовать преимущества новых возможностей по мере их выпуска, как мы это сделали с минификацией JS и CSS, где `esbuild` позволил Vite повысить производительность, избегая при этом нарушения работы его экосистемы.
