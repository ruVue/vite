...
::: warning Примечание
Связанные зависимости могут работать некорректно в окончательной сборке из-за различий в разрешении зависимостей.
Вместо этого используйте `npm package` для всех локальных зависимостей, чтобы избежать проблем в окончательном пакете.
:::
